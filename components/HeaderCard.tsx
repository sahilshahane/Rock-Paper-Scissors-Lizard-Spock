...
const HeaderCard: FC<headerCardProps> = ({ gameMode }) => {
    ...
    return (
        <div className="p-2 tablet:p-5">
            <div className="container-responsive mx-auto border-2 header border-gray-500 w-11/12 tabletM:w-4/5 tablet:w-3/5 p-5">
                <div className="grid grid-cols-2">
                    <div>
                        <img src={imgSrc} alt={`${score}`} className="flex-shrink-0" />
                    </div>
                    <div className="text-center relative">
                        <div className="absolute flex flex-col justify-center right-0 h-full score bg-white px-5">
